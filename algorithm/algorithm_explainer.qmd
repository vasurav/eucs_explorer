...
### How to Calculate a Rating for a Game (Game_Rating_Diff)
...
$$Game\_Rating\_Diff = 125+475\frac{\sin{\left(\min{\left(1, \frac{1-r}{0.5}\right)}\cdot 0.4 \pi\right)} }{\sin{\left(0.4 \pi\right)}}$$
